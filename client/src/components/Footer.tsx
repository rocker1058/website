  ...
  return (
    <footer className="bg-primary-950 border-t border-white/5 py-10">
      <div className="container mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p className="text-white/60 text-xs text-center md:text-right">¿Necesitas un abogado o abogada de familia en Manizales?<br />Alexandra Vásquez — especialista en divorcios, custodia y alimentos.</p>
